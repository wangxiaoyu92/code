                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">zkAdmin</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                        <div class="logo-element">zkAdmin
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                         ...
                         <@shiro.hasPermission name="system:resource:index">
                          ...
                          <@shiro.hasPermission name="system:staff:index">
                             <li>
                                 <a class="J_menuItem" href="${ctx!}/admin/staff/index">员工管理</a>
                             </li>
                          </@shiro.hasPermission>
                           <@shiro.hasPermission name="system:dept:index">
                              <li>
                                  <a class="J_menuItem" href="${ctx!}/admin/dept/index">部门管理</a>
                              </li>
                           </@shiro.hasPermission>
                        </ul>
                    </li>
